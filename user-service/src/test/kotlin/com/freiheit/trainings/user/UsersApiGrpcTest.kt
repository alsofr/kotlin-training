package com.freiheit.trainings.user

import com.freiheit.trainings.user.GlobalTestData.testUserBetty
import com.freiheit.trainings.user.GlobalTestData.testUserBettyId
import com.freiheit.trainings.user.api.UsersApiGrpc
import com.freiheit.fista.user.grpc.GetUsersReq
import com.freiheit.fista.user.grpc.UserApiGrpc
import com.freiheit.trainings.user.testing.InProcessServer
...
object GlobalTestData {
    ...
    val testUserBetty = UserService.User(id = testUserBettyId, nickname = "betty")
}
